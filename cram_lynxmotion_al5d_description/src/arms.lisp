...
(def-fact-group al5d-arm-facts (end-effector-link
  ...
  ;                            "LForeArm"
  ;                            "l_wrist")))
  (<- (arm-links al5d :left ("robot_base_cylinder"
                             "robot_base_top_box"
                             "arm"
                             "wrist"
                             "gripper")))

  (<- (gripper-joint al5d :left "Gripper"))
  (<- (gripper-joint al5d :right "GripperBis"))

  (<- (gripper-link al5d :left ?link)
    (bound ?link)
  ...
  (<- (robot-joint-states al5d :arm :left :park ?joint-states)
